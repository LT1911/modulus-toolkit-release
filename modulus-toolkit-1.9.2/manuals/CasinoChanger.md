...
2. Edit **C:\Program Files\PowerShell\Modules\modulus-toolkit\config\scope.json** and fill in the wanted configuration for COD_SOCIET, COD_ETABLI, CASINO_ID and the long and short names!
3. Check the current database and look for the CASINO_ID you want to reconfigure.
4. In Powershell: Run **Start-CasinoChanger** and follow the instructions within powershell.
